...
vim.api.nvim_create_autocmd("FileType", {
	...
	callback = function()
		...
		vim.keymap.set("n", "<leader>ns", function()
			...
			local snippets_dir = "/home/leminhohoho/note-taking/Monadikos/0 knowledge/1 snippets/"
		...
		vim.keymap.set("n", "<leader>nf", function()
			...
			local today = os.date("%Y-%m-%d")
			local filename = today .. "_" .. name .. ".md"
			local snippets_dir = "/home/leminhohoho/note-taking/Monadikos/0 knowledge/0 fleeting/"
